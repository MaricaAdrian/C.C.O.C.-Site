...
<html>
	...
	<div class="container text-center">
		<div class="page-header">
			<h1>Selectati din meniul de mai jos</h1>      
		</div>
		<div class="radio">
			...
			<p>
				...
				<strong>Atenţie la modul cum vă prezentaţi CV-ul</strong>
					<ul>
						...
						<li><strong>Acordaţi atenţie sporită fiecărui detaliu relevant,</strong> atât ca fond cât și ca formă; nu există scuză pentru greșelile de ortografie și de punctuaţie!</li>
					</ul>
				...
				<p>Cum să redactaţi Curriculum Vitae Europass?
					...
					<ul>
						<li>folosiţi interfaţa online disponibilă pe website-ul Europass (<a href="http://europass.cedefop.eu.int)">Interfata Europass</a>). CV-ul dumneavoastră poate fi apoi salvat în directorul ales</li>
			...
			<div class="col-md-12">
				...
				<p>
					...
					<ul>
						...
						<li>concepe scrisoarea într-o notă încrezătoare şi modestă în acelaşi timp. Dă dovada de entuziasm şi atitudine pozitivă</li>
		...
		<div class="container">
			...
			<div class="col-md-12">
				...
				<p>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Ca tehnică de selecţie, interviul este considerat fiind cel mai comod instrument dar, în acelaşi timp, o metodă subiectivă şi sensibilă la biasări sistematice. În ciuda popularităţii ridicate, s-a dovedit că această modalitate clasică de evaluare nu are valoare predictivă suficient de mare în prezicerea performanţelor profesionale ulterioare ale candididatului. Tehnica interviului are o serie de lipsuri şi limite. Acesta nu masoară ce ştiu candidaţii, doar cum pot răspunde la anumite întrebari generale, şi cum se comportă într-un mediu creat artificial. Permite în schimb aflarea modului în care candidatul se relaţioneaza cu muncă, cum s-a comportat în trecut în situaţii specifice şi în situaţii ipotetice. Orice interviu constă într-o serie de întrebări şi răspunsuri. Tipul întrebărilor folosite, formatul lor (cu răspunsuri închise sau deschise), precum şi ordinea acestora (fix sau variabil de la un intervievat la altul) determină gradul de structurare a interviului.
					
					<h4>Întrebări specifice interviurilor de selecţie</h4>
					<ul>
						<li>Cele mai frecvente sunt <strong>întrebările deschise</strong>. Ele se pun pentru evitarea răspunsurilor de tip da-nu şi în general pentru a-i pune pe candidaţi în situaţia de a vorbi, de a aborda o temă. Ex. Prezentaţi un proiect la care lucraţi acum! Ce probleme manageriale ai întâmpinat până acum? sau Povestiţi-ne cea mai recentă experienţă legată de munca care a avut un impact pozitiv asupra Dvs. Intervievatorul urmăreşte deschiderea candidatului, forţarea comunicaţiei.</li>
						<li><strong>Întrebări însoţitoare, complementare.</strong> Aceste întrebări se pun pentru detalierea răspunsurilor. Acestea urmează răspunsurile date la întrebările deschise. Ex. Cum ati reuşit ca fiecare din subordonaţii Dvs să termine la timp toate sarcinile?</li>
						<li><strong>Întrebarile directe.</strong> Sunt bine direcţionate şi îl obligă pe candidat să dea răspunsuri la subiect şi să comunice fapte concrete: Ex. Cum ai controlat munca subalternilor? De ce ai plecat de la acest loc de muncă? De ce ai plecat de la locul precedent de muncă?</li>
						<li><strong>Întrebari de tip de la A la Z.</strong> Reprezintă o combinaţie specială a întrebărilor deschise şi însoţitoare concentrate asupra personalităţii candidatului. Ex. Enumerati trei rezultate deosebite din cariera dvs. de până acum! Ce ai făcut? Cum ai procedat? De ce ai procedat aşa? De ce sunt importante pentru dvs? Intervievatorul este interesat de evidenţierea trăsăturilor de personalitate ale candidatului. Aceste întrebări sunt o combinaţie între întrebările directe şi intrebările condiţionate. Ex. Ce performanţe deosebite ai avut până acum în munca Dvs? Povestiţi-ne în detaliu!</li>
						<li><strong>Întrebari ţintite.</strong> Răspunsurile la aceste întrebări arată modul de gândire, de operare şi de acţiune a candidatului. Ex. Prezentaţi o acţiune organizată de dvs în ultima vreme. Poate ai avut una care nu a mers cum aţi fi vrut dvs. Ce nu s-a potrivit atunci? Poate puteţi vorbi şi despre deficienţele din munca unui coechipier din cauza căruia nu a reuşit acţiunea? De ce ai avut aşa de multe locuri de muncă într-un timp aşa de scurt? Ce credeţi, care au fost cauzele??</li>
						<li><strong>Întrebari provocative.</strong> Sunt adresate pentru a afla informaţii pe care candidatul preferă să le ascundă. Ex. În CV-ul dvs se observă o pauza de activitate; Ce ai făcut în acest timp? Ai făcut vreun tratament? Sau...aveţi o întrerupere în CV-ul Dvs. În perioada aceasta ce aţi făcut?</li>
					</ul>
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Mediul în care are loc interviul afectează mult eficientă acestuia. Modul în care este organizat interviul (pregătirea şi desfăşurarea acestuia), reflectă cultura, valorile şi imaginea organizaţiei. Acestea pot fi pozitive sau negative atat pentru candidat cât şi pentru intervievator.
					<br>
					
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;În literatura de specialitate deseori se pune problema modului în care sunt aşezate persoanele participante la interviu. Scopul pregătirii mediului în care se va desfăşura interviul este acela de a-i face pe interlocutori să se simtă confortabil şi capabili de a face schimb de informaţii. Cele mai des intâlnite forme sunt:
					<br>
					<em>Traditional</em> - intervievatorul este despartit de intervievat de un obstacol, o masa; este o abordare confruntationala, dar care nu ajuta la relaxarea si dezinhibarea celor doua persoane, impunand o formalitate exagerata;
					<br>
					<em><u>Poziţionarea scaunelor într-un unghi de 45° în jurul unei mese</u> - este o abordare mai puţin confruntaţională, dar care menţine totuşi tonul de formalitate ce ajută la atingerea scopului interviului.
					
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Intervievatul şi intervievatorul stau unul lângă celălalt, de aceeaşi parte a mesei - este o poziţie pe care de obicei o adoptă doi prieteni, sau un instructor şi elevul sau, nefiind o poziţie potrivită în cazul unui interviu de selecţie de personal.
					Inlăturarea obstacolului dintre cei doi îi face să se simtă mai relaxaţi, mai confortabil.
					Interviurile la care candidatul trebuie sa stea singur în faţa unei comisii, de care totodată îl desparte un obstacol, o catedră - sunt stresante. Aşadar, se recomandă o aranjare mai lejeră a comisiei şi a celui intervievat - în formă de U.
...
Centrul de Consiliere şi Orientare Profesională - Universitatea din Craiova
			...
			<div class="col-md-12">
				...
				<p>Scrisoarea de mulţumire poate fi trimisă după susţinerea primului interviu.
					...
					<ul>
						...
						<li>menţioneaza cel puţin un lucru care ţi-a lăsat o impresie plăcută la interviu (poate fi vorba de ospitalitate, atmosfera destinsă şi placută, subiectele interesante pe care le-a propus spre a fi discutate)</li>
					...
					<ul>
						...
						<li>ar fi de preferat ca ea să fie scrisă de mână şi trimisă prin poştă, dar în cazul în care acest lucru nu este posibil se acceptă şi varianta electronică (e-mail)</li>
