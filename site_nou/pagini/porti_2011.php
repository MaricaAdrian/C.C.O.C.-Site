...
<html>
	...
	<div class="col-md-12">
		<div class="jumbotron text-center">
			<h3 class="text-center">Porți deschise 2011</h3>
		</div>
		<div id="slides" class="text-center">
						...
						<?php 
							...
							for( $i = 1; $i <= $nr_imagini; $i++ ){ 
								echo "<img style=\"margin-left: 25%; margin-right: auto; max-height: 50%;max-width:50%;\" src=\"../imagini/porti_2011/images/(".$i.").jpg\">";
							}
						?>
		</div>
	</div>
