...
<html>
	...
	<div class="col-md-12">
		<div class="jumbotron text-center">
			<h3 class="text-center">Caravana Învățământului Oltean 2010</h3>
		</div>
		<div id="slides" class="text-center">
						<?php 
							$nr_imagini = 39;			
							for( $i = 1; $i <= $nr_imagini; $i++ ){ 
								echo "<img style=\"margin-left: 25%; margin-right: auto; max-height: 50%;max-width:50%;\" src=\"../imagini/caravana_2010/images/(".$i.").jpg\">";
							}
						?>
		</div>
	</div>
